...
`;customElements.define("better-switch-card-editor",class extends st{static get properties(){return{hass:{type:Object},config:{type:Object}}}setConfig(t){this._config={...rt,...t}}render(){return this.hass&&this._config?j`
